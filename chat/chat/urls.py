...
from chatapp.views import Login, Registrations, activate, ForgotPassword, resetpassword,newpassword,session
from django_short_url.views import get_surl
from django_short_url.models import ShortURL
from P2PChat.views import message_list, user_list, chat_view, message_view
...
urlpatterns = [
    ...
    path('resetpassword/<slug:surl>', views.resetpassword, name='resetpassword'),
